...
export default function Drawer({ open, onClose }) {
  ...
  return (
    <>
      ...
      <div
        onClick={onClose}
        className={`fixed inset-0 bg-[rgba(33,23,56,0.18)] z-30 transition-opacity duration-300 ${
      ...
      {/* Drawer */}
      <nav
        className={`fixed top-0 left-0 h-full w-[280px] z-40 bg-[#f6f4f9] transition-transform duration-300 ${
